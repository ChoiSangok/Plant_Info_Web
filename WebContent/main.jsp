...
<body>
	<%
		String userID = null; //세션확인
		if (session.getAttribute("userID") != null) { //userid라는 세션확인
			userID = (String) session.getAttribute("userID"); //확인되면 세션넘어감
		}
	%>
	<nav class="nav-area" >
	...
	<div class="container">
		<div class="jumbotron">
			<div class="container">
				<h1>공기정화  :) </h1>
				<p>미세먼지로 나빠지고 있는 공기! <br> PLANT IN 과 함께 미세먼지 좋은 식물을 알아보아요.</p>
				<a href="공기정화.jsp" role="button" style="color:red">자세히 알아보기</a>
			</div>
		</div>
	</div>
		...
		<div class="jumbotron">
			<div class="container">
				<h1>실내식물  :) </h1>
				<p>실내 인테리어로 탁월! <br> PLANT IN 과 함께 실내에서 키우기 좋은 식물을 알아보아요.</p>
				<a href="실내식물.jsp" role="button" style="color:red">자세히 알아보기</a>
			</div>
		</div>
	</div>
		...
		<div class="jumbotron">
			<div class="container">
				<h1>계절식물  :) </h1>
				<p>4계절로 무엇을키우면 좋을까? <br> PLANT IN 과 함께 4계절 내내, 계절 식물을 알아보아요</p>
				<a href="계절식물.jsp" role="button" style="color:red">자세히 알아보기</a>
			</div>
		</div>
	</div>
		...
		<div class="jumbotron">
			<div class="container">
				<h1>제습식물  :) </h1>
				<p>곧 다가올 여름! <br> PLANT IN 과 함께 집을 보송하게 해줄 식물을 알아보아요.</p>
				<a href="제습식물.jsp" role="button" style="color:red">자세히 알아보기</a>
			</div>
		</div>
	</div>
